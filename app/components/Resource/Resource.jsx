...
function scrollToElement(selector) {
  ...
  if (elem) {
    const scrollOptions = { block: 'center', behaviour: 'smooth' };
...
class Resource extends Component {
  ...
  verifyResource() {
    ...
    dataService
      .post(`/api/resources/${this.state.resource.id}/change_requests`, {
            ...
            <div className="org--aside">
              <div className="org--aside--content">
                <a
                  ...
                  },${resource.address.longitude}&dirflg=w`}
                  target="_blank"
                ...
                <Link
                  to={{ pathname: '/resource/edit', query: { resourceid: resource.id } }}
                  className="org--aside--content--button edit-button"
                >
                  Make Edits
                </Link>
                <button className="org--aside--content--button" onClick={this.verifyResource}>
                        ...
                        {resource.services.map(service => (
                          <li key={service.id}>
                            <a
                              ...
                              onClick={scrollToElement(`service-${service.id}`)}
                            >
                              {service.name}
                            </a>
                          </li>
