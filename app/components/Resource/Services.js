    ...
    return (
      <li className="service" id={`service-${this.props.service.id}`}>
        <div className="service--meta disabled-feature">
          <p>
            <ServiceCategory category={this.props.service.category} />
          </p>
        ...
        <ReactMarkdown
          ...
          source={this.props.service.long_description}
        />
        <div className="service--details-toggle" onClick={this.toggleVisible}>
          <span>
            {infoHidden ? (
              <span>
                More Info <i className="material-icons">keyboard_arrow_down</i>
              </span>
            ) : null}
          </span>
        </div>
          ...
          <div className="service-application-process-container">
            ...
            <div className="service--details-toggle" onClick={this.toggleVisible}>
              <span>
                {infoHidden ? null : (
                  <span>
                    Less Info <i className="material-icons">keyboard_arrow_up</i>
                  </span>
                )}
              </span>
            </div>
...
class Note extends Component {
  render() {
    return <li className="services--details--notes-list--item">{this.props.note.note}</li>;
  }
}
